...
\begin{itemize}
	...
	dell'ambiente
	\item i modelli della prima riga sono fully observable, ovvero l'agente è onnisciente
...
che massimizza l'action-utility function \(Q(s,a)\) (approfondita nei prossimi paragrafi - \hyperlink{q_function}{link}):
\[\pi^*(s) = \argmax_a Q(s,a)\]
...
La somma da massimizzare viene anche detta action-utility function o \hypertarget{q_function}{Q-function}:
...
ad un valore arbitrario (ad esempio 0) e ad ogni iterazione aggiorna le utilità di tutti gli stati attraverso la Bellman equation.
...
Impairments''. L'obiettivo è di guidare le persone con disabilità visive a muoversi in modo sicuro e autonomo, attraverso un

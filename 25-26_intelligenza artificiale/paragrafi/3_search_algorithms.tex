...
\begin{itemize}
	...
	viaggio
	\item \textbf{traveling salesperson problem}: trovare il percorso più breve che deve compiere il commesso viaggiatore per
...
Sfrutta l'approccio del Depth-limited DFS eseguendo ripetutamente il DFS con un limite di profondità crescente ad ogni iterazione

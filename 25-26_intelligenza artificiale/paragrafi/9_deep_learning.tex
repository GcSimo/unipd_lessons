...
modellare meglio valori contenuti e facilitano l'addestramento delle reti neurali. Alcuni esempi di funzioni sono:
...
\begin{itemize}
	...
	dell'ingresso per il peso, somme, funzioni di attivazione) è rappresentata come un nodo del grafo e i dati che fluiscono
...
\begin{itemize}
	...
	le classi, con una funzione di attivazione softmax che restituisce un vettore con valori compresi tra 0 e 1, interpretato
...
\begin{itemize}
	...
	propagazione degli errori ha molto poco effetto sull'aggiornamento dei pesi
\end{itemize}
...
reali e sintetici. Durante il training possono verificarsi i seguenti problemi come:
\begin{itemize}
...
Il transfer learning è una tecnica di apprendimento automatico in cui un modello addestrato su un compito specifico viene
...
affiancate tra di loro in un numero prossimo alla dimensione del vocabolario (ad esempio 128k). La struttura viene descritta
...
\begin{itemize}
	...
	\item \textbf{regularization strategies}: consistono nell'aggiungere vincoli su addestramenti successivi, ad esempio

...
dall'azione dell'agente. Viceversa si dice stochastic o non-deterministic se lo stato successivo dipende anche da fattori
casuali o imprevedibili. Per vivere in un ambiente non-deterministic, l'agente deve essere in grado di gestire l'incertezza
...
richiedono un transition model e un sensor model per aggiornare il modello interno che si basano rispettivamente sulle azioni

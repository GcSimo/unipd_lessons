...
\date{First semester 2025-26}

\begin{document}

\maketitle
\begin{abstract}
	Microelectronics laboratory notes for the first semester of the academic year 2025-26 at the University of Padua.
\end{abstract}
...
\include{paragrafi/1_prototyping_techiques.tex}
\include{paragrafi/2_laboratory_instrumentation.tex}
\include{paragrafi/3_mosfet_and_bjt.tex}
\include{paragrafi/4_op_amps.tex}
\include{paragrafi/5_linear_voltage_regulators.tex}
\include{paragrafi/6_signal_generators.tex}
\include{paragrafi/7_output_stages.tex}
\include{paragrafi/8_arduino.tex}

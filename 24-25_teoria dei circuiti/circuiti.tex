...
Si definisce la resistenza di porta in una sezione di circuito con generatori pilotati come la resistenza misurata quando si applica
una corrente di 1 \(A_{mpere}\), dopo aver spento tutti i generatori ideali e mantendendo accesi tutti i generatori pilotati.

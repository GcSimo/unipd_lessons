...
\begin{itemize}[topsep=5pt, itemsep=3pt]
	...
	taglia \(|i| > n_0\) in una sequenza di una o più sottoistanze più piccole \(<\!i_1, i_2, \dots i_k\!>\) di taglia
	\(|i_j| < |i|\) per ogni \(j\)
	\item \(A_C : \mathcal{S}* \to \mathcal{S}\), funzione di combine che combina la sequenza di soluzioni
	\(<\!s_1, s_2, \dots s_k\!>\) associate alle sottoistanze \(<\!i_1, i_2, \dots i_k\!>\) nella soluzione \(s\) associata
	all'istanza \(i\)
...
\Else \Comment{passo ricorsivo \(\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\)}
	\State \(<\!i_1, i_2, \dots i_k\!> \; \gets A_D(i)\) \Comment{divide \(\quad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\)}
	\For{\(j \gets 1\)}{\(k\)} \Comment{conquer \(\quad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\quad\:\)}
		\State \(s_j \gets D\&C(i_j)\)
	\EndFor
	\State \(s \gets A_C(<\!s_1, s_2, \dots s_k\!>)\) \Comment{combine \(\quad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\quad\)}
	\State \textbf{return} \(s\)
\EndIf
\end{algo}

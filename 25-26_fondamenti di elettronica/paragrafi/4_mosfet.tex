...
Come per la giunzione pn, le grandezze analizzate sono per unità di area del condensatore mos, per cui per ottenere i valori
effettivi è necessario moltiplicarle per l'area \(\Sigma_C = W \ccdot L\) del condensatore mos.
...
identificabile univocamente in quanto non ci sono frecce.

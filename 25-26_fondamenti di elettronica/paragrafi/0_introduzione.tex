...
\begin{center}
	\begin{tabular}{l c c c }
		\textbf{resistore (R)}: & \begin{circuitikz}[baseline=(current bounding box.center)]
			...
			\node at (1,-0.4) {\(v_R\)};
			\node at (1.7,-0.4) {--};
		\end{circuitikz} & \(\displaystyle \qquad v_R(t) = R \cdot i_R(t)\) & \(\displaystyle i_R(t) = \frac{v_R(t)}{R}\qquad\quad\;\) \\
		\midrule
		...
		\textbf{condensatore (C)}: & \begin{circuitikz}[baseline=(current bounding box.center)]
			...
			\node at (1,-0.7) {\(v_C\)};
			\node at (1.7,-0.6) {--};
		\end{circuitikz} & \(\displaystyle \qquad i_C(t) = C \frac{d v_C(t)}{d t}\) & \(\displaystyle v_C(t) = \frac{1}{C} \int_0^t i_C(t) \, dt\) \\
		\midrule
		...
		\textbf{induttore (L)}: & \begin{circuitikz}[baseline=(current bounding box.center)]
			...
			\node at (1,-0.4) {\(v_L\)};
			\node at (1.7,-0.4) {--};
		\end{circuitikz} & \(\displaystyle \qquad v_L(t) = L \frac{d i_L(t)}{d t}\) & \(\displaystyle i_L(t) = \frac{1}{L} \int_0^t v_L(t) \,dt\)
	\end{tabular}
\end{center}
...
\begin{itemize}
	...
	i potenziali degli altri nodi rispetto a questo.
...
\begin{center}
	\begin{tabular}{m{3cm} c m{10.1cm}}
		...
		nodo con il potenziale di riferimento scelto arbitrariamente a \(0 V\) \\[0.3cm]
		\midrule
		nodo di massa: &
...
\begin{itemize}
	...
	\item nel transitorio (\(t \geq 0\)): \(i_C(t) = C \frac{d v_C(t)}{d t}, \quad i_R = \frac{v_R(t)}{R}, \quad v_A = v_R(t) + v_C(t), \quad i_R(t) = i_C(t)\)
	...
	\[E_{v_A} = \int_{0}^{\infty} v_A \cdot i(t) dt = C \cdot v_A^2 \qquad\! E_R = \int_{0}^{\infty} R \cdot i^2(t) dt = \frac{C \cdot v_A^2}{2} \qquad\! E_C = \int_{0}^{\infty} v_C(t) \cdot i(t) dt = \frac{C \cdot v_A^2}{2}\]
\end{itemize}
...
\begin{minipage}{0.55\textwidth}
	\centering
	\includegraphics[width=0.8\textwidth]{immagini/1_intro/rc_carica.png}
\end{minipage}
...
\begin{itemize}
	...
	\item nel transitorio (\(t \geq 0\)): \(i_C(t) = C \frac{d v_C(t)}{d t}, \quad i_R = \frac{v_R(t)}{R}, \quad v_R(t) = v_C(t), \quad i_R(t) + i_C(t) = 0\)
	\item dalla legge delle correnti si ottiene un'equazione differenziale del primo ordine:
...
\begin{minipage}{0.55\textwidth}
	\centering
	\includegraphics[width=0.8\textwidth]{immagini/1_intro/rc_scarica.png}
\end{minipage}

...
\begin{center}
	...
	\begin{minipage}{0.2\textwidth}
		\centering simbolo logico del MUX 2:1
	\end{minipage}
	\begin{minipage}{0.38\textwidth}
		\centering MUX 2:1 a pass transistor con nmos
	\end{minipage}
	\begin{minipage}{0.38\textwidth}
		\centering MUX 2:1 a pass transistor con pmos
	\end{minipage}
\end{center}
...
\begin{center}
	\begin{minipage}{0.3\textwidth}
		...
		caratteristiche di trasmissione di un pass transistor nmos
	\end{minipage}
	...
	\begin{minipage}{0.3\textwidth}
		...
		caratteristiche di trasmissione di un pass transistor pmos
	\end{minipage}
\end{center}
...
\begin{center}
	...
	\begin{minipage}{0.25\textwidth}
		\centering trasmissione del valore degradato attraverso due pass transistor nmos in serie
	\end{minipage}
	\begin{minipage}{0.01\textwidth} \(\) \end{minipage}
	\begin{minipage}{0.25\textwidth}
		\centering trasmissione del valore degradato verso il gate di un pass transistor nmos
	\end{minipage}
	\begin{minipage}{0.01\textwidth} \(\) \end{minipage}
	\begin{minipage}{0.35\textwidth}
		\centering trasmissione del valore degradato verso una porta logica complementare (invertitore)
	\end{minipage}
\end{center}
...
\begin{center}
	...
	schema circuitale di una porta di trasmissione (transmission gate) \\ e relativo simbolo di abbreviazione
\end{center}
...
\begin{enumerate}
	...
	che minimizza il tempo di propagazione complessivo
...
%	\end{minipage}
	...
	\begin{minipage}{0.3\textwidth}
		\centering MUX 2:1 a pass transistor con nmos, non rigenerativo, bidirezionale, con escursione logica limitata
	\end{minipage}
	\begin{minipage}{0.3\textwidth}
		\centering MUX 2:1 a transmission gate, non rigenerativo, bidirezionale, con escursione logica completa
	\end{minipage}
	\begin{minipage}{0.38\textwidth}
		\centering MUX 2:1 a transmission gate con invertitori, rigenerativo, unidirezionale con escursione logica completa
	\end{minipage}
\end{center}
...
I singoli MUX 2:1 possono essere realizzati con trasmission gate con invertitori per garantire un'escursione logica completa e
un funzionamento rigenerativo e unidirezionale, con l'accorgimento di eliminare gli invertitori tra i nodi intermedi
\(X_0, X_1, X_2, X_3, Y_0, Y_1\) e lasciare solo quelli sugli ingressi e all'uscita.
\begin{center}
	...
	\begin{minipage}{0.3\textwidth}
		\centering \begin{circuitikz}
			\draw (0, 0) node[muxdemux, muxdemux def={w=2, Rh=5, Lh=7, NL=8, NR=1, NB=0, NT=3}, anchor=center] (MUX) {MUX};

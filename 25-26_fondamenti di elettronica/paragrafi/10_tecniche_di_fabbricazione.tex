...
Le fasi di costruzione sono svolte in un impianto di fabbricazione da tecnici specializzati che non necessariamente hanno
...
\begin{center}
	...
	\begin{minipage} {0.6\textwidth}
		...
		\vspace{5pt}
		\begin{enumerate}[start=3]
			\item si rimuove il fotoresist rimanente e si deposita l'ossido di isolamento (di bassa qualità siccome deve solo
...
\begin{itemize}
	\item minima risoluzione e tolleranza della fotolitografia

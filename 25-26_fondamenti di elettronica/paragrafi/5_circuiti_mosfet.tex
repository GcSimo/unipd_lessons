...
\[\frac{R_{n0}}{R_{p0}} = \frac{k_n' V_{DSATN} (V_{DD} - V_{TN} - \frac{V_{DSATN}}{2})}{k_p' V_{DSATP} (-V_{DD} - V_{TP} - \frac{V_{DSATP}}{2})} \approx \frac{k_n' V_{DSATN}}{-k_p' V_{DSATP}} \approx 3 \cdot \frac{2}{3} = 2\]

...
\usepackage{wrapfig} % per immagini con testo intorno
...
\include{paragrafi/1_introduzione}
\include{paragrafi/2_semiconduttori}
\include{paragrafi/3_diodo}
\include{paragrafi/4_mosfet}
\include{paragrafi/5_circuiti_mosfet}
\include{paragrafi/6_segnali_digitali}
\include{paragrafi/7_invertitore}
\include{paragrafi/8_logica_statica_complementare}
\include{paragrafi/9_pass_transistor}
\include{paragrafi/10_tecniche_di_fabbricazione}
\include{paragrafi/11_blocchi_logico_aritmetici}
\include{paragrafi/12_ottimizzazione_sommatore}
\include{paragrafi/13_latch_flip_flop}
\include{paragrafi/14_circuiti_sequenziali}
\include{paragrafi/15_clock_sincronizzazione}
\include{paragrafi/16_memorie}
\include{paragrafi/17_scaling_consumo}
\include{paragrafi/18_circuiti_logici_programmabili}
\include{paragrafi/19_asic_tpu}

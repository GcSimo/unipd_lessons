...
\begin{itemize}
	...
	\(\displaystyle \frac{d}{dt} \, \vec{a}(t) = \left(\frac{d}{dt} \, a_x(t) \; \vec{u_x} + \frac{d}{dt} \, a_y(t) \; \vec{u_y} + \frac{d}{dt} \, a_z(t) \; \vec{u_z}\right)\)
	\item[-] Dato un versore \(\vec{u}(t)\), la sua derivata è definita come \(\displaystyle \frac{d}{dt} \, \vec{u}(t) = \frac{d \, \theta(t)}{dt} \, \vec{u_\perp}(t)\)
...
\[\frac{d}{dt} \, \vec{r}(t) = \frac{d \vmod{\vec{r}(t)}}{dt} \; \vec{u_r}(t) + \vmod{\vec{r}(t)} \frac{d \, \theta(t)}{dt} \; \vec{u_\perp}(t)\]
